...
void APortalCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &APortalCharacter::Look);
...
void APortalCharacter::DoMove(float Right, float Forward)
{
...
void APortalCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void APortalCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void APortalCharacter::DoJumpEnd()
{
